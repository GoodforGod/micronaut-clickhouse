...
public class ClickHouseNativeConfiguration extends AbstractClickHouseConfiguration {
    ...
    private final ClickhouseNativeProperties clickhouseNativeProperties = new ClickhouseNativeProperties();
    ...
    public ClickHouseNativeConfiguration(ClickHouseConfiguration configuration) {
        ...
        configBuilder.withProperties(clickHouseProperties.asProperties());

        clickHouseProperties.asProperties().forEach((k, v) -> {
            if (StringUtils.isNotEmpty(v.toString()))
                this.properties.put(String.valueOf(k), String.valueOf(v));
        });

        this.properties.put(SettingKey.host.name(), clickHouseProperties.getHost());
    ...
    public String getJDBC() {
        final String host = getProperty(SettingKey.host)
